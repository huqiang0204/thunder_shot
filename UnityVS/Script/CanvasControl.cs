...
{   
    public class CanvasControl
    {
        ...
        #region language
        static readonly string[] L_declare = new string[] { "暂时只做了示例，本人水\r\n平有限,没有美工,直接拿的雷霆战机\r\n图片做测试,音频更加不懂，试了\r\n一下太鬼畜，就不上音频了,我邮箱"+
            "\r\nhuqiang1990@outlook.com想要素材\r\n仓库有明显bug未修复\r\n想要工作qwq",
            "just test" };
        ...
        static CirclePropertyEx BT_back = new CirclePropertyEx()
        {
            ...
            imagebase = new ImageProperty() {sorting=5, scale = new Vector3(0.3f, 0.3f),
                location = new Vector3(-2f, -4.5f, 1), imagepath = BK_picture }
        ...
        {
            location = new Vector3(0.5f, -0.2f, 1),
            fontsize = 55,
        ...
        {
            location = new Vector3(0f, -1.2f, 1),
            fontsize = 33,
        ...
        public static void Initial()
        {
            ...
            bk_id = QueueSourceEX.CreateImage(QueueSourceEX.def_transform, bk_ground);
            test_id = QueueSourceEX.CreateText(QueueSourceEX.def_transform, new TextProperty()
            {
                location = new Vector3(0, 0, 1),
                color = Color.green,
                scale = new Vector3(0.1f, 0.1f),
            ...
            temp.imagebase.location = new Vector3(2, 3, 1);
            temp.text.text = lang_sample;
            temp.property.click = SingleModeClick;
            buff_button[0] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, temp);
            temp.imagebase.location = new Vector3(2, -3, 1);
            temp.text.text = lang_lang;
            temp.property.click = LanguageClick;
            buff_button[1] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, temp);
            temp.imagebase.location = new Vector3(2, -2, 1);
            temp.text.text = lang_store;
            temp.property.click = StoreClick;
            buff_button[2] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, temp);
        }
        ...
        static void SingleModeClick()
        {
            if (clear_current_button != null)
                clear_current_button();
            BT_level1.imagebase.location = new Vector3(0,-0.5f,1);
            BT_level1.text.text = lang_thunder;
            BT_level1.property.click = thunder_click;
            buff_button[0]=QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, BT_level1);
            BT_level1.imagebase.location = new Vector3(0, 0.5f, 1);
            BT_level1.text.text = lang_project;
            BT_level1.property.click = Level_project_click;
            buff_button[1]=QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, BT_level1);
            clear_current_button = single_mod_clear;
            back = Initial;
            buff_button[2] = QueueSourceEX.CreateCircleButton(QueueSourceEX.def_transform, BT_back);
        }
        ...
        static void clear_GOC()
        {
            ...
            QueueSourceEX.ReCylceBackGround();
        ...
        public static void GameOverCallBack(bool win ,int count)
        {
            ...
            back = Initial;
            buff_button[0]=QueueSourceEX.CreateCircleButton(QueueSourceEX.def_transform,BT_back);
            buff_imgid[0] = QueueSourceEX.CreateImage(QueueSourceEX.def_transform, goc_notify);
            if(win)
            {
            ...
            buff_imgid[1]= QueueSourceEX.CreateText(QueueSourceEX.def_transform, goc_text);
            goc_text1.text = lang_forgold + count.ToString();
            buff_imgid[2] = QueueSourceEX.CreateText(QueueSourceEX.def_transform,goc_text1);          
        }
        static void Game_back()
        {
            GameControl.SuspendGame();
            EdgePropertyEx temp = BT_edge_def;
            temp.imagebase.location = new Vector3(0, 0.5f, 1);
        ...
        static void Store_Left_Right(int d)
        {
            ...
            {
                case 0:
                    i = DataSource.Plane_all.Length;
                    if (i <= 1)
                        return;
                    Store.DeletePlaneView();
                    view_index+=d;
                    if (view_index >= i)
                        view_index = 0;
                    if (view_index < 0)
                        view_index += i;
                    Store.PlaneView(DataSource.Plane_all[view_index]);
                    QueueSourceEX.GetTextBase(buff_button[5]).textmesh.text
                    = lang_fire + DataSource.Plane_all[view_index].bullet.attack.ToString() + "\r\n" + lang_blood +
                DataSource.Plane_all[view_index].blood.ToString() + "\r\n" + lang_gold + DataSource.Plane_all[view_index].gold.ToString();
                    break;
                case 1:
                    i = DataSource.SB_all.Length;
                    if (i <= 1)
                        return;
                    Store.DeleteSecondView();
                    view_index+=d;
                    if (view_index >= i)
                        view_index = 0;
                    if (view_index < 0)
                        view_index += i;
                    Store.SecondView(DataSource.SB_all[view_index]);
                    QueueSourceEX.GetTextBase(buff_button[5]).textmesh.text
                    = lang_fire + DataSource.SB_all[view_index].bullet.attack.ToString() + "\r\n" +
                    "\r\n" + lang_gold + DataSource.SB_all[view_index].gold.ToString();
                    break;
                case 2:
                    i = DataSource.Wing_all.Length;
                    if (i <= 1)
                        return;
                    Store.DeleteWingView();
                    view_index+=d;
                    if (view_index >= i)
                        view_index = 0;
                    if (view_index < 0)
                        view_index += i;
                    Store.WingView(DataSource.Wing_all[view_index]);
                    QueueSourceEX.GetTextBase(buff_button[5]).textmesh.text
                    = lang_fire + DataSource.Wing_all[view_index].bullet.attack.ToString() + "\r\n" +
                     lang_gold + DataSource.Wing_all[view_index].gold.ToString();
                    break;
                case 3:
                    i = DataSource.Shiled_all.Length;
                    if (i <= 1)
                        return;
                    Store.DeleteShiledView();
                    view_index+=d;
                    if (view_index >= i)
                        view_index = 0;
                    if (view_index < 0)
                        view_index += i;
                    Store.ShiledView(DataSource.Shiled_all[view_index]);
                    QueueSourceEX.GetTextBase(buff_button[5]).textmesh.text
                    = lang_defence + DataSource.Shiled_all[view_index].defence.ToString() + "\r\n" +
                    lang_gold + DataSource.Shiled_all[view_index].gold.ToString();
                    break;
                case 4:
                    i = DataSource.all_skill.Length;
                    if (i <= 1)
                        return;
                    Store.DeleteSkillView();
                    view_index+=d;
                    if (view_index >= i)
                        view_index = 0;
                    if (view_index < 0)
                        view_index += i;
                    Store.SkillView(DataSource.all_skill[view_index]);
                    QueueSourceEX.GetTextBase(buff_button[5]).textmesh.text
                    = lang_fire + DataSource.all_skill[view_index].attack.ToString() + "\r\n" +
                     lang_gold + DataSource.all_skill[view_index].gold.ToString();
                    break;
            }
        }
        ...
        static void ListItemClick(int index)
        {
            ...
            else
            {
                ...
                {
                    case 0:
                        Store.PlaneView(DataSource.Plane_all[0]);
                        break;
                    case 1:
                        Store.SecondView(DataSource.SB_all[0]);
                        break;
                    case 2:
                        Store.WingView(DataSource.Wing_all[0]);
                        break;
                    case 3:
                        Store.ShiledView(DataSource.Shiled_all[0]);
                        break;
                    case 4:
                        Store.SkillView(DataSource.all_skill[0]);
                        break;
                }
            }          
        }
        static void StoreClick()
        {
            ...
            QueueSourceEX.ResetImage(QueueSourceEX.def_transform,bk_ground,bk_id);
            
            BT_edge_left.imagebase.location = new Vector3(-2.2f, 0f, 1);
            BT_edge_left.property.click = Store_Left_Click;
            buff_button[0] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, BT_edge_left);
            BT_edge_right.imagebase.location = new Vector3(2.2f,0f,1);
            BT_edge_right.property.click = Store_Right_Click;
            buff_button[1] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, BT_edge_right);

            EdgePropertyEx epe = BT_edge_def;
            epe.imagebase.location = new Vector3(-1.88f, -3.46f, 1);
            epe.text.text = lang_back;
            epe.property.click = BackClick;
            buff_button[2] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, epe);
            epe.imagebase.location = new Vector3(0, -3.46f, 1);
            epe.text.text = lang_buy;
            epe.property.click = BuyClick;
            buff_button[3] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, epe);
            epe.imagebase.location = new Vector3(1.88f, -3.46f, 1);
            epe.text.text = lang_openstorage;
            epe.property.click = StorageClick;
            buff_button[4] = QueueSourceEX.CreateEdgeButton(QueueSourceEX.def_transform, epe);
            
            Store.View_Start(new Vector3(0,0,1));
            Store.PlaneView(DataSource.Plane_all[0]);

            TextProperty tp = new TextProperty() { color = Color.red, location = new Vector3(-2, -1, 1),scale=new Vector3(0.1f,0.1f) };
            tp.text = lang_fire + DataSource.Plane_all[0].bullet.attack.ToString()+"\r\n"+lang_blood+
                DataSource.Plane_all[0].blood.ToString()+"\r\n" + lang_gold+ DataSource.Plane_all[0].gold.ToString();
            buff_button[5] = QueueSourceEX.CreateText(QueueSourceEX.def_transform, tp);

            tp.text=lang_gold+ FileManage.GetGood(9).exp.ToString();
            tp.color = Color.green;
            tp.location.y = -3;
            buff_button[6] = QueueSourceEX.CreateText(QueueSourceEX.def_transform, tp);
            ...
            if (g.level > 0)
                ibd.imgpath = new string[] { DataSource.img_all_plane[g.id&0xffff] };
            else
                ibd.imgpath = null;                     
            ...
            if (g.level > 0)
                ibd.imgpath = new string[] { DataSource.img_all_second[g.id & 0xffff] };
            else
                ibd.imgpath = null;
            ...
            if (g.level > 0)
                ibd.imgpath = new string[] { DataSource.img_all_wing[g.id & 0xffff] };
            else
                ibd.imgpath = null;
            ...
            if (g.level > 0)
                ibd.imgpath = new string[] { DataSource.Shiled_all[g.id & 0xffff].imgpath};
            else
                ibd.imgpath = null;
            ...
            if (g.level > 0)
                ibd.imgpath = new string[] { DataSource.img_all_skill[g.id & 0xffff] };
            else
                ibd.imgpath = null;
            ...
            switch (viewtype)
            {
                case 0:
                    if (lg.Count > 0)
                        for (int i = 0; i < lg.Count; i++)
                        {
                            ...
                            ibd.imgpath = new string[] { DataSource.img_all_plane[index] };
                ...
                case 1:
                    if (lg.Count > 0)
                        ...
                        {
                            int index = lg[i].id & 0xffff;
                            ibd.imgpath = new string[] { DataSource.img_all_second[index] };
                            string s = (lg[i].level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            lb_01.data.Add(ibd);
                        }
                ...
                case 2:
                    if (lg.Count > 0)
                        ...
                        {
                            int index = lg[i].id & 0xffff;
                            ibd.imgpath = new string[] { DataSource.img_all_wing[index] };
                            string s = (lg[i].level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            lb_01.data.Add(ibd);
                        }
                ...
                case 3:
                    if (lg.Count > 0)
                        ...
                        {
                            int index = lg[i].id & 0xffff;
                            ibd.imgpath = new string[] { DataSource.Shiled_all[index].imgpath };
                            string s = (lg[i].level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            lb_01.data.Add(ibd);
                        }
                ...
                case 4:
                    if (lg.Count > 0)
                        ...
                        {
                            int index = lg[i].id & 0xffff;
                            ibd.imgpath = new string[] { DataSource.img_all_skill[index] };
                            string s = (lg[i].level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            lb_01.data.Add(ibd);
                        }
        ...
        static void BuyClick()
        {
            if(storage_show)//deploy
            {
                if (lg.Count > 0)
                {
                    ...
                    switch (viewtype)
                    {
                        case 0:                                                     
                            ItemBindData ibd = new ItemBindData();
                            ibd.imgpath = new string[] { DataSource.img_all_plane[p_id] };
                            string s = (g.level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            QueueSourceEX.ChangeItem(buff_button[10], view_index, ibd);
                            p_id = FileManage.GetGood(lb_index1).id & 0xffff;
                            ibd.imgpath = new string[] { DataSource.img_all_plane[p_id] };
                            ibd.text = new string[] { lang_mainweapon };
                            QueueSourceEX.ChangeItem(buff_button[11], lb_index1, ibd);
                            lg[view_index] = g;
                            break;
                        case 1:
                            ibd.imgpath = new string[] { DataSource.img_all_second[p_id] };
                            ...
                            break;
                        case 2:
                            ibd.imgpath = new string[] { DataSource.img_all_wing[p_id] };
                            s = (g.level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            QueueSourceEX.ChangeItem(buff_button[10], view_index, ibd);
                            p_id = FileManage.GetGood(lb_index1).id & 0xffff;
                            ...
                            break;
                        case 3:
                            ibd.imgpath = new string[] { DataSource.Shiled_all[p_id].imgpath };
                            s = (g.level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            QueueSourceEX.ChangeItem(buff_button[10], view_index, ibd);
                            p_id = FileManage.GetGood(lb_index1).id & 0xffff;
                            ...
                            break;
                        case 4:
                            ibd.imgpath = new string[] { DataSource.img_all_skill[p_id] };
                            s = (g.level & 0xffff).ToString();
                            ibd.text = new string[] { lang_level + s };
                            QueueSourceEX.ChangeItem(buff_button[10], view_index, ibd);
                            p_id = FileManage.GetGood(lb_index1).id & 0xffff;
            ...
            else//buy
            {
                ...
                {
                    case 0:
                        pice= DataSource.Plane_all[view_index].gold;
                        break;
                    case 1:
                        pice= DataSource.SB_all[view_index].gold;
                        break;
                    case 2:
                        pice= DataSource.Wing_all[view_index].gold;
                        break;
                    case 3:
                        pice= DataSource.Shiled_all[view_index].gold;
                        break;
                    case 4:
                        pice=DataSource.all_skill[view_index].gold;
                        break;
                }
                if(g.exp-pice>=0)
                {
